      ...
      if @registration.update_attributes(reg_params)
        if @registration.payment_method == "Credit Card"
          @ccp = CreditCardPayment.new(
            ...
            :billing_name => "#{@registration.parent_guardian1.first_name} #{@registration.parent_guardian1.last_name}",
            :billing_street1 => @registration.parent_guardian1.street1,
            :billing_street2 => @registration.parent_guardian1.street2,
            :billing_city => @registration.parent_guardian1.city,
            :billing_province => @registration.parent_guardian1.province,
            :billing_country => @registration.parent_guardian1.country,
            :billing_postalcode => @registration.parent_guardian1.postal_code
          )
